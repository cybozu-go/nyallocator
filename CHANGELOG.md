...
### Added
    ...
    - Add metrics about NodeTemplate's annotations in [#12](https://github.com/cybozu-go/nyallocator/pull/12)

### Changed

    - Minor fix in [#13](https://github.com/cybozu-go/nyallocator/pull/13)
